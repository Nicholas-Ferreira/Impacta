...
def conta_recursiva(lista, numero):
  if len(lista) == 0:
    return 0
  return (lista[0] == numero) + conta_recursiva(lista[1:], numero)
...
def filtro_recursivo(lista, numero):
  ...
  return [lista[0]] + filtro_recursivo(lista[1:], numero)
...
def troca_recursiva(lista, tirar, colocar):
  ...
  if lista[0] == tirar:
    lista[0] = colocar
  return [lista[0]] + troca_recursiva(lista[1:], tirar, colocar)
